...
const ModalInputBox = ({ type, name, labelText, input, setInput, valid, helperText, readOnly, disabled, onBlur, $isRequestCompleted, requestType }) => {
    return (
        <StyledInputBox
            type={type}
            name={name}
...
const StyledInputBox = styled(InputBox)`
    ...
    Label {
        ...
        position: relative;
        &::after {
        content: ${(props) => (props.name === 'devTerm' || (props.name === 'commonPron' && props.requestType === 'mod') ? "' *'" : "''")};
        color: #ff0808;
        position: aboslute;
        right: 5%;
        top: 0;
