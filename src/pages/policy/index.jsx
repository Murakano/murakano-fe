  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          &lt;머라카노&gt;('app.murakano.site')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의
          목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.
        </Paragraph>
        <List>
          <ListItemTitle>가. 홈페이지 회원가입 및 관리</ListItemTitle>
          <ListItem>
          ...
          <ListItemTitle>나. 재화 또는 서비스 제공</ListItemTitle>
          <ListItem>
            서비스 제공, 콘텐츠 제공, 맞춤 서비스 제공, 본인인증, 연령인증 등을 목적으로 개인정보를 처리합니다.
          </ListItem>
          <ListItemTitle>다. 마케팅 및 광고에의 활용</ListItemTitle>
          <ListItem>
      ...
      <Section>
        <SectionTitle>2. 개인정보 파일 현황</SectionTitle>
        <Paragraph>개인정보 파일명 : 개인정보처리방침</Paragraph>
        <Paragraph>개인정보 항목 : 이메일, 비밀번호, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보</Paragraph>
        <Paragraph>수집방법 : 홈페이지</Paragraph>
        <Paragraph>보유근거 : 개인정보보호법제15조 (정보주체의 동의)</Paragraph>
        <Paragraph>보유기간 : 5년</Paragraph>
      </Section>

      <Section>
        <SectionTitle>3. 개인정보의 처리 및 보유 기간</SectionTitle>
        <Paragraph>
          ① &lt;머라카노&gt;은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은
          개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.
        </Paragraph>
        <Paragraph>② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</Paragraph>
        <List>
          <ListItemTitle>1. 홈페이지 회원가입 및 관리</ListItemTitle>
          <ListItem>
            홈페이지 회원가입 및 관리와 관련한 개인정보는 수집.이용에 관한 동의일로부터 &lt;5년&gt; 까지 위 이용목적을
            위하여 보유.이용됩니다.
          </ListItem>
          <ListItem>보유근거 : 개인정보보호법제15조 (정보주체의 동의)</ListItem>
          <ListItemTitle>2. 서비스 제공</ListItemTitle>
          <ListItem>
            서비스 제공과 관련한 개인정보는 수집.이용에 관한 동의일로부터 &lt;5년&gt;까지 위 이용목적을 위하여
            보유.이용됩니다.
          </ListItem>
          <ListItem>보유근거 : 개인정보보호법제15조 (정보주체의 동의)</ListItem>
          <ListItemTitle>3. 마케팅 및 광고에의 활용</ListItemTitle>
          <ListItem>
            마케팅 및 광고에의 활용와 관련한 개인정보는 수집.이용에 관한 동의일로부터 &lt;5년&gt;까지 위 이용목적을
            위하여 보유.이용됩니다.
          </ListItem>
          <ListItem>보유근거 : 개인정보보호법제15조 (정보주체의 동의)</ListItem>
        </List>
      ...
      <Section>
        ...
        <List>
          <ListItem>
            ① 정보주체는 &lt;머라카노&gt;에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수
            있습니다.
          </ListItem>
          <ListItem>
            ② 제1항에 따른 권리 행사는&lt;머라카노&gt;에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편,
            모사전송(FAX) 등을 통하여 하실 수 있으며 &lt;머라카노&gt;은(는) 이에 대해 지체 없이 조치하겠습니다.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            ⑥ &lt;머라카노&gt;은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등
      ...
      <Section>
        ...
        <List>
          ...
          <ListItem>필수항목 : 이메일, 비밀번호, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보</ListItem>
        </List>
      </Section>
      ...
      <Section>
        ...
        <List>
          <ListItem>파기절차</ListItem>
          <ListItem>
            이용자가 입력한 정보는 목적 달성 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련
            법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다.
          </ListItem>
          <ListItem>
            이 때, DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다.
          </ListItem>
          <ListItem>파기기한</ListItem>
          <ListItem>
